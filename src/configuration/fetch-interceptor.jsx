...
import {setToken} from "../utilities/SessionService";
            ...
            return promise
                .then((response) => {
                    if (response.ok) {
                        ...
                        typeof this.isTokenExpiry === "function" &&
                        this.isTokenExpiry(response, request, controller)
                    ) {
                    ...
                    } else if (typeof this.onRequestFailure === "function") {
                        this.onRequestFailure(response, request, controller);
                        return response;
                    }
                })
                .catch((error) => {
                    this.onConnectionRefused(error, controller);
                    return {status: 10000};
                });
        };
    }
