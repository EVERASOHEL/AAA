...
export default class AddproductModel extends React.Component {
  ...
  validateAddProduct = (key, value, index) => {
    ...
    if (key === "sellingprice" || key === "all") {
      ...
      } else if (!commonFunction.isNotEmptyAndValidNumber(obj.sellingprice)) {
        obj.isValidatorAddProduct = false;
        obj.isSellingPriceError = "Please enter valid number";
      } else {
    ...
    if (key === "costprice" || key === "all") {
      ...
      } else if (!commonFunction.isNotEmptyAndValidNumber(obj.costprice)) {
        obj.isValidatorAddProduct = false;
        obj.isCostPriceError = "Please enter valid number";
      } else {
