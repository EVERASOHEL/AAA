...
export const pageName = "PurchaseOrderdd";
...
export const ActionTypes = keyMirrorRecursive(
    {
        ...
        PURCHASE_ORDER_REQUEST:undefined,
        PURCHASE_ORDER_RESPONSE:undefined,
        ...
        ORDER_FOR_PAYMENT_DATA_REQUEST:undefined,
        ORDER_FOR_PAYMENT_DATA_RESPONSE:undefined,
        PAYMENT_HISTORY_REQUEST:undefined,
        PAYMENT_HISTORY_RESPONSE:undefined,
